    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.registration_status}>
          ...
          <button onClick={() => setRegistrationModal(true)} className={styles.register_button}>Register for Whitelist</button>
          <Modal show={registrationModal} hide={() => setRegistrationModal(false)} heading='Prerequisite'>
            <div className={styles.reg_modal}>
              ...
              <p>We require the above in order to assign you the “Whitelisted” role in our Discord and notify you of your Whitelist status via our Telegram bot.</p>
            </div>
          </Modal>
        </div>
