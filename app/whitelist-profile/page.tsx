  ...
  const socials: SOCIALS[] = [
    {
      ...
      action: <>Not subscribed to Kyzzen Newsletter yet.</>
    },
    {
      ...
      action: <>Not following Kyzzen yet.</>
    },
    {
      ...
      status: profile?.discordVerified,
      action: <>Haven&apos;t joined discord server yet.</>
    },
    {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.profile_card}>
          <div className={styles.profile_info}>
            <Image className={styles.profile_image} src={profile?.bannerURL ?? "/images/founder.png"} alt="girl" width={65} height={65} priority />
        ...
        <div className={styles.registration_status}>
          <span >Registration Status: <span className={styles.not_registered}> Not Registered</span></span>
        ...
        <div className={styles.section}>
          <div className={styles.section_header}>
            <h2>
              ...
              <Tooltip
                placement={
                  window.innerWidth < screens.mobile.max
                    ? "bottom-start"
                    : "right"
                }
                text="hello world"
