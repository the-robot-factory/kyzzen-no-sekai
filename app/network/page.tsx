        ...
        <div className={styles.network_container}>
            ...
            <section className={styles.header_section}>
                ...
                <p className={styles.description}>
                    The Kyzzen Network consists of a group of selected individuals who have made significant contributions to the NFT ecosystem and are dedicated to supporting Kyzzen&apos;s mission of offering free, high-quality data, analytics, and education in the NFT space.
                </p>
            </section>
