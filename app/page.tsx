    ...
    <div>
      <main>
        <div className={styles.hero + ' ' + anton.className}>
          ...
          <Image className={styles.hero_boy} src="/images/hero-boy.png" alt="boy" width={482} height={660} priority />
        </div>
        <div className={styles.panel}>
          <div className={styles.about}>
            ...
            <div className={styles.panel_text}>
              ...
              <p>
                KNS is a collection of 5,000 digital avatars set in the “World of Kyzzen”, which is a fictional representation of
                the NFT space
              </p>
          ...
          <div className={styles.art}>
            ...
            <div className={styles.panel_text}>
              ...
              <p>
                KNS is a groundbreaking experiment that fuses cutting-edge AI technology with the dynamic, modern manga style of
                our artist, MIDORIMAE, unlocking a new level of creativity and pushing artistic boundaries like never before!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={styles.panel}>
          <div className={styles.founder}>
            <div className={styles.panel_img}>
              <Image src="/images/body-3.png" alt="X" width={500} height={500} priority color="white" className={styles.bg} />
            </div>
            <div className={styles.panel_border}></div>
            <div className={styles.panel_text}>
          ...
          <div className={styles.utility}>
            <div className={styles.panel_img}>
              <Image src="/images/body-4.png" alt="X" width={500} height={500} priority color="white" className={styles.bg} />
            </div>
            <div className={styles.panel_border}></div>
            <div className={styles.panel_text}>
