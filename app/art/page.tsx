    ...
    <main className={styles.main}>
      ...
      <section className={`${styles.panel} ${styles.single}`}>
        <div className={styles.panel_text}>
          <h2>4. The Result</h2>
          <p>
            A generative NFT collection with unparalleled diversity and rich visual storytelling, <br />
            every piece a true collaboration between human creativity and machine precision
          </p>
        </div>
        <div className={styles.panel_img}>
