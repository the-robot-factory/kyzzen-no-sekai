...
export const ENDPOINTS = [
  {
    name: "mainnet" as ENV,
    endpoint:
      "https://nd-183-619-919.p2pify.com/dc8333733604e4a1a743b484df46955b/",
    ...
    if (endpoint && !connection && !sendConnection) {
      setConnection(
        new Connection(endpoint, {
          wsEndpoint:
            "wss://ws-nd-183-619-919.p2pify.com/dc8333733604e4a1a743b484df46955b",
        })
      )
      setSendConnection(
        new Connection(endpoint, {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      if (connection && connected) {
        id = await connection.onAccountChange(
